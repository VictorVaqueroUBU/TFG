 ...
 */
final class Version20241219110247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE curso (id INT AUTO_INCREMENT NOT NULL, codigo_curso VARCHAR(10) NOT NULL, nombre_curso VARCHAR(255) NOT NULL, horas DOUBLE PRECISION NOT NULL, objetivos LONGTEXT DEFAULT NULL, contenidos LONGTEXT DEFAULT NULL, destinatarios LONGTEXT DEFAULT NULL, requisitos LONGTEXT DEFAULT NULL, justificacion LONGTEXT DEFAULT NULL, coordinador VARCHAR(255) DEFAULT NULL, participantes_edicion SMALLINT NOT NULL, ediciones_estimadas SMALLINT NOT NULL, plazo_solicitud VARCHAR(255) DEFAULT NULL, observaciones LONGTEXT DEFAULT NULL, visible_web TINYINT(1) NOT NULL, horas_virtuales DOUBLE PRECISION NOT NULL, calificable TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_CA3B40EC99E811E1 (codigo_curso), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE formador (id INT AUTO_INCREMENT NOT NULL, nif VARCHAR(9) NOT NULL, apellidos VARCHAR(50) NOT NULL, nombre VARCHAR(50) NOT NULL, organizacion VARCHAR(100) NOT NULL, correo_aux VARCHAR(50) DEFAULT NULL, telefono VARCHAR(30) DEFAULT NULL, observaciones LONGTEXT DEFAULT NULL, formador_rj SMALLINT DEFAULT NULL, usuario_id INT NOT NULL, UNIQUE INDEX UNIQ_B93AC18DADE62BBB (nif), UNIQUE INDEX UNIQ_B93AC18DDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE sesion (id INT AUTO_INCREMENT NOT NULL, fecha DATE NOT NULL, hora_inicio TIME NOT NULL, duracion INT NOT NULL, observaciones LONGTEXT DEFAULT NULL, tipo SMALLINT NOT NULL, edicion_id INT NOT NULL, formador_id INT NOT NULL, INDEX IDX_1B45E21BD651B81E (edicion_id), INDEX IDX_1B45E21B9B4172E7 (formador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(50) NOT NULL, verified TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, password_changed_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE formador ADD CONSTRAINT FK_B93AC18DDB38439E FOREIGN KEY (usuario_id) REFERENCES usuario (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formador DROP FOREIGN KEY FK_B93AC18DDB38439E');
